  ...
  return (
    <div className="featured_categories">
      <div className="container mx-auto my-5 grid grid-cols-1 gap-5 px-2 sm:my-8 sm:grid-cols-2 sm:px-4 md:px-8 lg:grid-cols-3">
        <div className="item relative rounded-lg border border-purple-100 bg-gradient-to-br from-purple-200 to-transparent p-3 sm:h-52 sm:p-5">
          <h3 className="title text-xl font-bold text-purple-800">Dry Foods</h3>
          <p className="text-purple-500">View our dry food collections </p>
          <Link
        ...
        <div className="item relative rounded-lg border border-purple-100 bg-gradient-to-br from-orange-200 to-transparent p-3 sm:h-52 sm:p-5">
          <h3 className="title text-xl font-bold text-orange-800">
            Honey Items
          </h3>
          <p className="text-orange-500">View our honey collections </p>
          <Link
            href={'/all-products?categories=dry-foods'}
        ...
        <div className="item relative rounded-lg border border-green-100 bg-gradient-to-br from-green-200 to-transparent p-3 sm:h-52 sm:p-5">
          <h3 className="title text-xl font-bold text-green-800">
            Herbal Products
          </h3>
          <p className="text-green-500">View our herbal collections </p>
          <Link
            href={'/all-products?categories=dry-foods'}
